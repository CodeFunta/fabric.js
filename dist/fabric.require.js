    ...
    fabric.util.object.extend(fabric.Canvas.prototype, {
        ...
        _initEventListeners: function() {
            ...
            if (typeof Hammer !== "undefined" && typeof Hammer.Manager !== "undefined") {
                ...
                hammer_mc.get("pinch").set({
                    enable: true
                });
                hammer_mc.get("rotate").set({
                    enable: true
                });
                hammer_mc.get("pinch").recognizeWith("rotate");
                hammer_mc.get("pan").set({
                    direction: Hammer.DIRECTION_ALL
                });
                hammer_mc.get("swipe").set({
                    direction: Hammer.DIRECTION_ALL
                });
...
(function() {
    ...
    fabric.util.object.extend(fabric.Object.prototype, {
        ...
        drawBorders: function(ctx) {
            ...
            var w = this.getWidth(), h = this.getHeight(), strokeWidth = this.strokeWidth, capped = this.strokeLineCap === "round" || this.strokeLineCap === "square", vLine = this.type === "line" && this.width === 0, hLine = this.type === "line" && this.height === 0, sLine = vLine || hLine, strokeW = capped && hLine || !sLine, strokeH = capped && vLine || !sLine;
            if (vLine) {
        ...
        drawControls: function(ctx) {
            ...
            if (this.hasRotatingPoint) {
                this._drawControl("mtr", ctx, methodName, left + width / 2 - scaleOffset, top - this.rotatingPointOffset - this.cornerSize / 2 - padding);
            }
            ctx.restore();
            return this;
        },
...
(function(global) {
    ...
    fabric.Image = fabric.util.createClass(fabric.Object, {
        ...
        _render: function(ctx, noTransform) {
            ...
            this._element && ctx.drawImage(this._element, x + imageMargins.marginX, y + imageMargins.marginY, imageMargins.width, imageMargins.height);
            this._renderStroke(ctx);
        },
...
(function(global) {
    ...
    fabric.Text = fabric.util.createClass(fabric.Object, {
        ...
        _getSVGLeftTopOffsets: function(textLines) {
            var lineTop = this.useNative ? this.fontSize * this.lineHeight : -this._fontAscent - this._fontAscent / 5 * this.lineHeight, textLeft = -(this.width / 2), textTop = this.useNative ? this.fontSize * this.lineHeight - .25 * this.fontSize : this.height / 2 - textLines.length * this.fontSize - this._totalLineHeight;
            return {
